    ...
    <Layout title={'Our brand'}>
      <section>
        ...
        <div className="container"><div className="row section-title justify-content-center text-center">
          <div className="col-md-9 col-lg-8 col-xl-7"><div className="lead">When using the Bimbala logo, please use the images provided below. If you're in need of it in a different format / resolution, <a href={"/contact-us"} className="nav-link fade-page px-0 py-2">please ask.</a></div></div></div>
        </div>
        <div className="container">
          <div className="row justify-content-center text-center">
            ...
            <div className="col-md-auto" data-aos="fade-up" data-aos-delay="200">
              ...
              <br /><div className="p-5 mb-3 bg-primary text-white">#246865</div>
              </div>
            </div> 
