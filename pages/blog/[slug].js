            ...
            <div className="row justify-content-center">
              <div className="col-xl-7 col-lg-8 col-md-10">
                ...
                <div className="my-4 my-sm-5 card card-body flex-sm-row justify-content-between align-items-center">
                  <div className="h5 mb-sm-0">Share this article:</div>
                  <div className="d-flex">
                    <a href="#" className="btn btn-sm btn-primary rounded-circle mx-1">
                    ...
                    <a href="#" className="btn btn-sm btn-primary rounded-circle mx-1">
                      <img src="/img/icons/social/linkedin.svg" alt="Linked In" className="icon icons-m bg-white"/>
                    </a>
                  </div>
                </div>
              </div>
