...
@section('content')
    ...
    <div class="py-20">
        <div class="sm:mx-auto sm:w-full sm:max-w-5xl">
            ...
            <p class="max-w-md mx-auto mt-5 text-lg text-gray-600 lg:max-w-none lg:text-xl sm:text-center">Everything you need to help you succeed. Simple transparent pricing to fit businesses of any size.</p>
