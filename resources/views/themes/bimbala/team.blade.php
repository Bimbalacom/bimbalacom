        ...
        <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="{{ asset('themes\bimbala\bimbala\images\team\gkanev.jpg') }}">
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="{{ asset('themes\bimbala\bimbala\images\team\lalexandrov.jpg') }}">
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
                ...
                <div class="flex flex-col items-center justify-center p-10">
                    <img class="w-32 h-32 mb-6 rounded-full" src="no">
