...
<section class="w-full bg-gray-900 text-base text-white no-underline">
    <div class="px-6 mx-auto max-w-7xl xl:px-12">
        <div class="box-border flex flex-wrap pt-20 pb-0 leading-tight md:pb-12">
            <div class="flex-initial w-1/2 px-2 pb-12 leading-tight md:w-1/4">
                <div class="box-border">
                    <a href="{{ route('wave.home') }}" class="relative flex items-center mb-5">
                    ...
                    <p class="mt-8 mb-5 font-bold tracking-wide text-gray-100 md:text-xl">
                        Connect with us
                    </p>
                    <span class="inline-grid grid-cols-2 md:grid-cols-3 gap-5 md:gap-4 w-full sm:w-2/3 sm:ml-auto sm:mt-0">
            ...
            <div width="6,3" class="flex-initial w-1/2 px-2 pb-12 leading-tight md:w-1/4">
                <div class="box-border ">
                    ...
                    <ul class="p-0 m-0 leading-tight list-none">
                        <li class="box-border py-2 text-left md:mb-1">
                        ...
                        <li class="box-border py-2 text-left md:mb-1">
                            <a href="{{ route('use-case') }}"
                                class="leading-tight hover:text-gray-400">Use Cases</a>
                        </li>
                        <li class="box-border py-2 text-left md:mb-1">
        ...
        <div class="flex flex-col items-center justify-between w-full py-10 leading-none border-t border-gray-800 lg:flex-row">
            <ul class="flex mb-6 list-none lg:flex-grow-0 lg:flex-shrink-0 lg:my-0">
                <li class="box-border block font-semibold text-left">
                    <a href="/privacy-policy" class="pr-5 mr-5  border-r border-gray-700 cursor-pointer">Privacy Policy</a>
                </li>
                <li class="box-border block font-semibold text-left">
                    <a href="/gdpr" class="pr-5 mr-5  border-r border-gray-700 cursor-pointer">GDPR</a>
                </li>
                <li class="box-border block font-semibold text-left">
                    <a href="/terms-and-conditions" class="pr-5 mr-5  border-r border-gray-700 cursor-pointer">Terms and Conditions</a>
                </li>
                <li class="box-border block font-semibold text-left">
                    <a href="/sitemap.xml" class=" cursor-pointer">Sitemap</a>
                </li>
            </ul>
