        ...
        <div class="px-12 pt-12 pb-20">
            <div class="space-y-12 text-justify">
                <div class="mb-20 space-y-5 sm:mx-auto sm:space-y-4">
                    <h3 class="relative text-3xl tracking-tight sm:text-4xl mt-4">Values</h3>
                    <p>
                    ...
                    <h3 class="relative text-3xl tracking-tight sm:text-4xl mt-4">Target</h3>
                    <p>
            ...
            <h3 class="text-left pb-12 text-3xl tracking-tight sm:text-4xl mt-4">Part of our history</h3>
