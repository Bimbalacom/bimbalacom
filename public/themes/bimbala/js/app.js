...
/***/ "./assets/js/alpine/spotlightCallbackListener.js":
/*!*******************************************************!*\
  !*** ./assets/js/alpine/spotlightCallbackListener.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    setQueryTerm: function setQueryTerm() {
      var _this = this;

      var value = this.$refs.input.value;

      if (value.length > 1) {
        this.query = value; //Make an API request to the Meilisearch endpoint

        fetch(this.apiSearchUrl + encodeURIComponent(value)).then(function (res) {
          return res.json();
        }).then(function (data) {
    ...
    showSearchBar: function showSearchBar() {
      ...
      // Show Searchbar
      this.show = true;
      this.query = ''; // after showing focus in input
    ...
    previous: function previous() {
      ...
      this.currentIndex--; // if index is less than 0 set the input value to the of query
      ...
      if (this.currentIndex < 0) {
        this.$nextTick(function () {
          ...
          _this3.$refs.input.value = _this3.query;
        });
        return;
      ...
      this.$nextTick(function () {
        ...
        _this3.$refs.input.value = _this3.queryFilter[_this3.currentIndex].title;
      });
      this.observer();
    },
    next: function next() {
      ...
      if (this.currentIndex >= this.queryFilter.length - 1) return;
      this.currentIndex++;
    ...
    observer: function observer() {
      ...
      var element = document.getElementById("item-".concat(this.currentIndex));
      var parent = this.$refs.parent;
      var elementTop = element.offsetTop;
      var elementBottom = elementTop + element.clientHeight;
      var parentTop = parent.scrollTop;
      var parentBottom = parentTop + parent.clientHeight; // Scroll  bottom
...
/***/ "./assets/js/alpine/spotlightCallbackListenerExistenceChecker.js":
/*!***********************************************************************!*\
  !*** ./assets/js/alpine/spotlightCallbackListenerExistenceChecker.js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    setQueryTerm: function setQueryTerm() {
      ...
      if (value.length > 1) {
        this.query = value; //Make an API request to the endpoint
...
/* harmony import */ var _alpine_spotlightCallbackListener__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./alpine/spotlightCallbackListener */ "./assets/js/alpine/spotlightCallbackListener.js");
/* harmony import */ var _alpine_spotlightCallbackListenerExistenceChecker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./alpine/spotlightCallbackListenerExistenceChecker */ "./assets/js/alpine/spotlightCallbackListenerExistenceChecker.js");
...
document.addEventListener('alpine:init', function () {
  ...
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('spotlight', _alpine_spotlightCallbackListener__WEBPACK_IMPORTED_MODULE_1__["default"]);
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('spotlightExistenceChecker', _alpine_spotlightCallbackListenerExistenceChecker__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
